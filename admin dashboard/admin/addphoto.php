...
<form action="glink.php" method="POST" enctype="multipart/form-data">
     <input type="hidden" name="title_id">
    <div class="row">
      
        <div class="col-50">
          <label class="cat">Select album name</label>
          <?php
          ...
          ?>
            ...
            <button id="save" type="submit"  name="submit">Next</button>
        </div>
</form>
